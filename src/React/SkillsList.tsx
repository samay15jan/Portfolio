...
const CategoryIcons = {
  ...
  "Build Products & Systems": (
    <svg
      ...
      className="w-6 h-6 text-[var(--sec)] opacity-70"
    >
      <path d="M75.64 29.72 64.36 55.1M83.22 30.56l18.93 11.85-18.93 11.84M56.78 30.56 37.85 42.41l18.93 11.84" /><rect x="2" y="2" width="136" height="97.5" rx="11.64" /><path d="M5.46 82.46h114.1M38.88 132.98h62.24M59.77 102.43l-.57 5.29-11.96 25.26M80.23 102.43l.58 5.29 11.95 25.26" /><rect x="2" y="2" width="136" height="97.5" rx="11.64" /><path d="M5.46 82.46h114.1M38.88 132.98h62.24M59.77 102.43l-.57 5.29-11.96 25.26M80.23 102.43l.58 5.29 11.95 25.26" />
    </svg>
  ),
  "Community & Writing": (
    <svg
...
const SkillsList = () => {
  ...
  const skills = {
    "Cloud, DevOps & Infrastructure": [
      "AWS, CI/CD, Docker, and containerized workflows",
      "Automating processes to improve developer efficiency",
    ],

    "Systems & Linux": [
      "Linux, system internals, and self-hosting",
      "Breaking things to understand them better",
    ],

    "Build Products & Systems": [
      "Design and develop full-stack web and mobile apps",
      "Focus on fast, clean, and intuitive experiences",
      "Build reliable, scalable backend systems",
    ],

    "Community & Writing": [
      "Document my work and share what I learn",
      "Write technical blogs and open-source insights",
    ],
  };
