...
const Container = styled.div`
  ${tw`mb-32 lg:mt-8 mt-96 mr-10 relative`}
`;
  ...
  return (
    <Container align={align}>
      ...
      <button
        className={
          hideArrow
            ? "mt-12 mr-9 w-14 h-14 rounded-full"
            : "mt-12 mr-9 w-14 h-14 ring ring-2 ring-opacity-50 ring-white rounded-full"
        }
      >
        {hideArrow ? (
          ""
        ...
        >
          <motion.circle
            ...
            onTap={handleClick}
          />
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="-150 0 850 500">
            <motion.polyline
