  ...
  return (
    <div
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start md:gap-10 text-black">
            <div
              ...
              <div
                ...
                <div
                  className="h-4 w-4 rounded-full bg-black border border-black p-2" />
              </div>
              <h3
        ...
        <div
          ...
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-red-200 via-red-500 to-transparent from-[0%] via-[10%] rounded-full" />
        </div>
      </div>
    </div>
  );
