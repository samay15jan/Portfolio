...
const EyeBall = ({ opacity }) => {
  ...
  const [color1, setColor1] = useState("#a0a0a0")
  const [color2, setColor2] = useState("#a0a0a0")
  ...
  return (
    <div className="relative z-2 w-screen h-screen" style={{ opacity }}>
      <svg className='absolute top-[-20rem] z-20 w-screen h-2/2' version="1.1" xmlns="http://www.w3.org/2000/svg">
        {/* Left Eye */}
        <path
          id="eye1"
        ...
        <circle
          ...
          r={30 * scale}
          fill={color1}
          onMouseEnter={() => setColor1("#E53935")}
          onMouseLeave={() => setColor1("#a0a0a0")}
        />
        {/* Right Eye */}
        <path
          id="eye2"
        ...
        <circle
          ...
          r={30 * scale}
          fill={color2}
          onMouseEnter={() => setColor2("#E53935")}
          onMouseLeave={() => setColor2("#a0a0a0")}
        />
      </svg>
    </div>
  );
